/*1671771668,,JIT Construction: v1006770255,en_US*/
        ...
        with (this) {
          ...
          __d(
            ...
            function (a, b, c, d, e, f, g) {
              ...
              c == null && (c = 5e3);
              var q =
                  (d = (h || (h = b("Env"))).timesliceReduceSpreadEnabled) !=
                  null
                    ? d
                    : !1,
              ...
              var D = {
                ...
                guard: function (a, c, d) {
                  ...
                  d = function () {
                    ...
                    try {
                      for (
                        var u = arguments.length, w = new Array(u), y = 0;
                        y < u;
                        y++
                      )
                        w[y] = arguments[y];
                  ...
                  d[n] = {};
                  (i || (i = b("ErrorGuard"))).applyWithGuard(y, null, [
                    m,
                    c,
                    f,
                  ]);
          ...
          __d(
            ...
            function (a, b, c, d, e, f, g) {
              ...
              function E(a, b, c, d, e, f, g, j) {
                ...
                g = g + (j === "compact" ? b : k) + e;
                d
                  ? (g += " max-height: calc(100% - " + f.toString() + "px);")
                  : (g += " max-height: 0;");
                switch (a) {
                  case "right":
                    g += " right: " + (c + 4) + "px;";
  ...
  i.src =
    ...
    encodeURIComponent(
      '{"error":"LOAD", "extra": {"name":"' +
        ...
        '","revision":"1006770255","namespace":"FB","message":"' +
        e.message +
        '"}}'
    );
