...
__d(
  "warningBlue",
  ["Bootloader", "SiteData", "WarningFilter", "cr:983844"],
  function (a, b, c, d, e, f, g) {
    function a(a, b) {}
    b = a;
    c = b;
    ...
    function k() {
      ...
      i = c("requestIdleCallbackAcrossTransitions")(function (a) {
        ...
        while (h.length > 0 && a.timeRemaining() > 0)
          d("ReactDOM").unmountComponentAtNode(h.pop());
        h.length > 0 && k();
      });
    }
    function l(a, b) {
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function q(a) {
      ...
      d = i.jsx(b("ReactXHPContext").Provider, {
        value: { bigPipeContext: d },
        children: h,
      });
      j && (d = i.jsx(j, { value: a, children: d }));
      e
        ? (h = b("nullthrows")(
            g.parentNode,
            "Error: container doesn't have a parent"
          ))
        : ((h = document.createComment(" react-mount-point-unstable ")),
          r(g, h));
    ...
    function r(a, c) {
      ...
      if (e && e.nodeType === j && e.nodeValue === " end-react-placeholder ") {
        ...
        while (
          !(e.nodeType === j && e.nodeValue === " begin-react-placeholder ")
        );
        d.removeChild(e);
      }
      d.replaceChild(c, a);
