...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    c == null && (c = 5e3);
    var q =
        (d = (h || (h = b("Env"))).timesliceReduceSpreadEnabled) != null
          ? d
          : !1,
    ...
    var D = {
      ...
      guard: function (a, c, d) {
        ...
        d &&
          ...
          e > 0 &&
          Math.random() < 1 / e &&
          (t = new Error("deferred execution source"));
        d = function () {
          ...
          try {
            ...
            if (!g.isRoot || n) return a.apply(this, w);
              ...
              return (i || (i = b("ErrorGuard"))).applyWithGuard(a, this, w, {
                name: "TimeSlice" + (c ? ": " + c : ""),
                deferredSource: t,
              });
          } finally {
    ...
    b("wrapFunction").setWrapper(function (a, b) {
      return D.guard(a, b, { registerCallStack: !0 });
    }, "entry");
    a.TimeSlice = D;
    e.exports = D;
  },
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function i(a, b, d) {
      ...
      c("isDollyFBURI")(c("getRequestConstUri")())
        ? (g = c("XRefererFrameController").getURIBuilder().getURI().toString())
        : c("isOculusDotComURI")(c("getRequestConstUri")())
        ? (g = "/common/referer_frame.php")
        : c("isWorkplaceDotComURI")(c("getRequestConstUri")()) &&
          c("gkx")("5626")
        ? (g = "/common/referer_frame.php")
        : (h && c("isInternalFBURI")(c("getRequestConstUri")())) ||
          (!h && !c("lowerFacebookDomain").isValidDocumentDomain())
        ? (g = "/intern/common/referer_frame.php")
        : (g = c("XRefererFrameController")
            .getURIBuilder()
            .getURI()
            .toString());
      d == null &&
    ...
    var h = new Map(),
      ...
      k = {
        addToQueue: function (a, b, d, e, f, g, i) {
          if (c("CookieConsent").hasConsent(1)) {
            f
              ? c("Cookie").setWithoutChecksIfFirstPartyContext(a, b, d, e, i)
              : c("Cookie").setWithoutChecks(a, b, d, e, i);
            return;
          }
          if (h.has(a)) return;
          h.set(a, {
