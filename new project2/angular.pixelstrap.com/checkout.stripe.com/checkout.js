            ...
            if (!origins.isStripeHosted(src)) {
              if (origins.isLocalhost(src)) {
                return console.error(
                  "Checkout needs to be loaded directly from \nhttps://checkout.stripe.com/checkout.js\nOtherwise your integration will not work in production."
                );
              } else {
                this.trackSelfHostedError();
                return console.error(
                  "Checkout needs to be loaded directly from https://checkout.stripe.com/checkout.js"
                );
              }
            }
          }
    ...
    (function () {
      ...
      Checkout = (function () {
        ...
        Checkout.prototype.createView = function () {
          ...
          path =
            "/v3/oivkx0oP8BgueCG8QFpDfA.html?distinct_id=" +
          ...
          iframeFallback = (function (_this) {
            return function () {
              ...
              _this.view = new IframeView(
                _this.onToken,
                _this.host,
                "/v3/oivkx0oP8BgueCG8QFpDfA.html"
              );
...
(function () {
  ...
  if (((ref = this.StripeCheckout) != null ? ref.__app : void 0) == null) {
    ...
    if (
      ((ref1 = this.StripeCheckout) != null ? ref1.__forceView : void 0) != null
    ) {
      app.setForceView(this.StripeCheckout.__forceView);
    }
    if (
      ((ref2 = this.StripeCheckout) != null ? ref2.__forceAppType : void 0) !=
      null
    ) {
      app.setForceAppType(this.StripeCheckout.__forceAppType);
    }
    if (
      ((ref3 = this.StripeCheckout) != null ? ref3.__host : void 0) &&
